...
export default function StudentAcademicsBoard() {
  ...
  return (
    <div className={classes.root}>
      <Typography variant="BM20">Student academic Board</Typography>
