...
import { getWeekDays } from "../../../../shared/calendar/CalendarUtils";
...
export default function WeakDays({
    ...
    <>
      <tr>
        {getWeekDays().map((day: any, index: number) => {
          ...
          const selected_day =
            !display_full_calendar && index === getDay(selected_date);
          return (
